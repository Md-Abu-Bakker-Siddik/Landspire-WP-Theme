...
if( !class_exists( 'Landspire_RC_Sweet_Custom_Menu' ) ) {
class Landspire_RC_Sweet_Custom_Menu {
    ...
    {
        wp_enqueue_style('jquery.fonticonpicker.min.css', LANDSPIRE_TEMPLATE_URI . '/assets/js/plugins/iconpicker/css/jquery.fonticonpicker.min.css', array(), 'all');
        wp_enqueue_style('jquery.fonticonpicker.grey.min.css', LANDSPIRE_TEMPLATE_URI . '/assets/js/plugins/iconpicker/themes/grey-theme/jquery.fonticonpicker.grey.min.css', array(), 'all');
        wp_enqueue_script('jquery.fonticonpicker.js', LANDSPIRE_TEMPLATE_URI . '/assets/js/plugins/iconpicker/jquery.fonticonpicker.js', array('jquery'));
    }
	...
	*/
	function rc_scm_add_custom_nav_fields( $menu_item ) {
		...
		if( landspire_get_redux_option( 'header-menu-megamenu-enable-megamenu' ) == 1 ) {
	...
	*/
	function rc_scm_edit_walker($walker,$menu_id) {
		...
		return 'Landspire_Walker_Nav_Menu_Edit_Custom';
...
$GLOBALS['sweet_custom_menu'] = new Landspire_RC_Sweet_Custom_Menu();


get_template_part( LANDSPIRE_FRAMEWORK_FOLDER . '/custom-nav-walker/edit_custom_walker' );
get_template_part( LANDSPIRE_FRAMEWORK_FOLDER . '/custom-nav-walker/custom_walker' );