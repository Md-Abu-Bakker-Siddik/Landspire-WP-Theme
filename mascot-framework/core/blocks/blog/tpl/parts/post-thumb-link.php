<?php
	$link_url = landspire_get_rwmb_group( 'landspire_' . "blog_mb_pf_link_settings", 'link_url' );
	$link_target = landspire_get_rwmb_group( 'landspire_' . "blog_mb_pf_link_settings", 'link_target' );
